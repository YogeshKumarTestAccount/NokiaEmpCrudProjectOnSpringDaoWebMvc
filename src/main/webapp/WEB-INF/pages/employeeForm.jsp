...
<head>
    ...
    <title>Nokia Employee Information</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title">
                    Nokia Corporation Employee Details
                </h3>
            </div>
            <div class="panel-body">
                <form:form id="employeeRegisterForm" cssClass="form-horizontal" modelAttribute="employee" method="post" action="saveEmployee">
                    ...
                    <div class="form-group">
                         <form:label path="name" cssClass="control-label col-xs-3">Emp Name</form:label>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <form:label path="age" cssClass="control-label col-xs-3">Emp Age</form:label>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="salary">Emp Salary</form:label></div>
                        <div class="col-xs-6">
